                            ...
                            <div className="w-full flex flex-col gap-6">
                                ...
                                <div className="w-full flex flex-col gap-2">
                                    ...
                                    <label className="flex items-center border border-slate-200 rounded-md overflow-hidden w-full">
                                        ...
                                        <input onChange={handleFileChange(setAkte)} type="file" className="hidden" />
                                        <span className="px-4 py-2 text-gray-500 flex-grow">{akte ? akte : "Upload File"}</span>
                                    </label>
                                </div>
                                ...
                                <div className="w-full flex flex-col gap-2">
                                    ...
                                    <label className="flex items-center border border-slate-200 rounded-md overflow-hidden w-full">
                                        ...
                                        <input onChange={handleFileChange(setFamilyRegister)} type="file" className="hidden" />
                                        <span className="px-4 py-2 text-gray-500 flex-grow">{familyRegister ? familyRegister : "upload file"}</span>
                                    </label>
                                </div>
                                ...
                                <div className="w-full flex flex-col gap-2">
                                    ...
                                    <label className="flex items-center border border-slate-200 rounded-md overflow-hidden w-full">
                                        ...
                                        <input onChange={handleFileChange(setTkCertificate)} type="file" className="hidden" />
                                        <span className="px-4 py-2 text-gray-500 flex-grow">{tkCertificate ? tkCertificate : "upload file"}</span>
                                    </label>
                                </div>
                                ...
                                <div className="w-full flex flex-col gap-2">
                                    ...
                                    <label className="flex items-center border border-slate-200 rounded-md overflow-hidden w-full">
                                        ...
                                        <input onChange={handleFileChange(setFoto)} type="file" className="hidden" />
                                        <span className="px-4 py-2 text-gray-500 flex-grow">{foto ? foto : "upload foto"}</span>
                                    </label>
                                </div>
